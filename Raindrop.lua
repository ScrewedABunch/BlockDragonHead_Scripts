...
MainFrame.Position = UDim2.new(0.379272908, 0, 0.159743726, 0)
...
local function BIFCDE_fake_script() -- Speed.LocalScript 
...
coroutine.wrap(BIFCDE_fake_script)()
local function LDTEI_fake_script() -- SpaceGrav.LocalScript 
...
coroutine.wrap(LDTEI_fake_script)()
local function RGUOXEY_fake_script() -- Speed_2.LocalScript 
...
coroutine.wrap(RGUOXEY_fake_script)()
local function BJDVL_fake_script() -- RockyAdmin.LocalScript 
...
coroutine.wrap(BJDVL_fake_script)()
local function WIIX_fake_script() -- InfYield.LocalScript 
...
coroutine.wrap(WIIX_fake_script)()
local function NPQEDYL_fake_script() -- Nameless.LocalScript 
...
coroutine.wrap(NPQEDYL_fake_script)()
local function JOMUDLU_fake_script() -- DexExplorer.LocalScript 
...
coroutine.wrap(JOMUDLU_fake_script)()
local function TALA_fake_script() -- Sussy.LocalScript 
...
coroutine.wrap(TALA_fake_script)()
local function EUMX_fake_script() -- Backflip.LocalScript 
...
coroutine.wrap(EUMX_fake_script)()
local function RYXBRPF_fake_script() -- Animation.LocalScript 
...
coroutine.wrap(RYXBRPF_fake_script)()
local function JPFWXM_fake_script() -- Jerk.LocalScript 
...
coroutine.wrap(JPFWXM_fake_script)()
local function YXFU_fake_script() -- BlackHole.LocalScript 
...
coroutine.wrap(YXFU_fake_script)()
local function MBAMMZ_fake_script() -- Attach.LocalScript 
...
coroutine.wrap(MBAMMZ_fake_script)()
local function INMTFX_fake_script() -- Reload.LocalScript 
...
coroutine.wrap(INMTFX_fake_script)()
local function BFYD_fake_script() -- Chaos.LocalScript 
...
coroutine.wrap(BFYD_fake_script)()
local function HKZD_fake_script() -- RC7.LocalScript 
...
coroutine.wrap(HKZD_fake_script)()
local function OHXEOGT_fake_script() -- Elysian.LocalScript 
...
coroutine.wrap(OHXEOGT_fake_script)()
local function TTFRLOA_fake_script() -- Zeph.LocalScript 
...
coroutine.wrap(TTFRLOA_fake_script)()
local function DKKMRLO_fake_script() -- OpenClose.LocalScript 
...
coroutine.wrap(DKKMRLO_fake_script)()
